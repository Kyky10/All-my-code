from Data import pygame as pygame
from Data.random import randint 
from Data import program as p
from Data.program import size, player_i, two_player_i, min_cub_move_speed, max_cub_move_speed, game_display, mode, clock, snake_speed, background, score, cub_score
    ...
    try:
        ...
        while not game_exit:
            ...
            if not pause:
                ...
                x_nimiq = randint(x_nimiq, x_nimiq + 2)
                y_nimiq = randint(y_nimiq, y_nimiq + 2)
